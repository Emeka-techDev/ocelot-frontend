...
const Service: React.FC = () => {
  return (
    <div className="">        
        ...
        <div className='md:translate-y-[2%]  z-50'>
            <section className='custom-container'>
                <h1 className='text-left mt-7 font-primary font-extrabold  text-[38px] md:text-[60px] lg:text-[91px] leading-[50px] md:leading-[64px] lg:leading-[95px] md:w-[500px] opacity-100 transform-none'>The Ocelot advantage</h1>
                ...
                <div className='grid md:grid-cols-2 gap-5 pr-7 md:pl-0'>
